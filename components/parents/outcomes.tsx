...
const outcomes = [
  {
    ...
    description: "A clearer sense of what matters in everyday parenting decisions around technology.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: "More constructive ways to talk about phones, gaming, social media and online life.",
  },
  {
    icon: Home,
...
export function ParentsOutcomes() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
            PATI is designed to help parents understand digital pressures more clearly, and to leave
            with approaches they can use at home.
          </p>
        </div>
