    ...
    <section className="bg-muted/30 py-20 lg:py-28">
      <div className="container mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          <p className="text-sm text-muted-foreground">
            'Parenting the Tech-Savvy Child' is delivered as a structured 8-module programme (M1–M8) over 4 weeks, each session builds practical understanding and confidence for parents week by week.
          </p>
        </div>
