      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-xl leading-relaxed text-foreground/80 sm:text-2xl">
            'Parenting the Tech-Savvy Child' is a comprehensive 4-week programme and equips parents with expert knowledge and practical tools to guide their children through the digital age.
          </p>
