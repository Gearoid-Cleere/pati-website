...
export function SchoolsProgrammeOverview() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto mb-20 max-w-2xl text-center lg:mb-24">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            Eight comprehensive modules delivered to parents over the programme duration
          </p>
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {modules.map((module) => (
            <div
              key={module.title}
              className="rounded-xl border border-border/60 bg-background p-8 transition-all duration-300 hover:border-border hover:shadow-md lg:p-9"
            >
