        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="max-w-xl">
            ...
            <h1 className="font-serif text-4xl font-medium leading-tight tracking-tight text-foreground md:text-5xl lg:text-6xl">
              <span className="text-balance">Reduce Stress. Improve Focus. Support Working Parents.</span>
            </h1>
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground md:text-xl">
              PATI delivers practical, expert-led sessions that help employees manage children&apos;s technology use at home — reducing personal stress, improving concentration at work, and strengthening your wellbeing offering.
            </p>
